...
class AnyMargueeWidget extends StatefulWidget {
  AnyMargueeWidget(
      {@required this.child, Key key, this.marginLeft, this.betweenSpacing, this.width, this.height, this.speedRate = 1})
      : super(key: key);
...
class _AnyMargueeWidgetState extends State<AnyMargueeWidget> {
  ...
  void startTimer() {
    _anyMargueeTimer = Timer.periodic(Duration(microseconds: 16), (timer) {
      ...
      if (_scrollController.hasClients) _scrollController.jumpTo(
          distance + (1 / AnyMargueeSpeed.NORMAL_SPEED) * widget.speedRate);
    });
  }
            ...
            return Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final distance = (index == 0 ? widget.marginLeft : widget
                      .betweenSpacing);
                  return Container(
